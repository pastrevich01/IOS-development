...
/*
 ...
 - Продемонстрировать команды intersection, isSubset, union, subtractic
 */
...
// try! - может выполняться без do catch на свой страх и риск. В случае ошибки произойдет fail программы т.к. ошибка не будет обработана
...
// Example
// - Смотрите пример из предыдущей задачи
